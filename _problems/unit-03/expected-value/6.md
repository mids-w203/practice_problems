...
statement: |
    ...
    Suppose that all 38 outcomes have equal probabilities. Compute the expected
    values of the following bets. In each case you bet one dollar and when you win
